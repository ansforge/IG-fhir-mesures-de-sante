# Exemple de bundle FHIR pour un bilan lipidique et une glycémie - Guide d'implémentation FHIR - Mesures de santé v3.2.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-bundle-flux-alimentation-biologie"]
  },
  "type" : "transaction",
  "entry" : [{
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-cholesterol-hdl"]
      },
      "text" : {
        "status" : "extensions",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-cholesterol-trigly"]
      },
      "text" : {
        "status" : "extensions",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-cholesterol-total"]
      },
      "text" : {
        "status" : "extensions",
