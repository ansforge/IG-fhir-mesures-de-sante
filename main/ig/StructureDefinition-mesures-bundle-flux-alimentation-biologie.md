...
| Active as of 2026-06-26 | *Computable Name*:MesBundleFluxAlimentationBiologie |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Observation",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-cholesterol-aspect"]
      }]
    },
    {
