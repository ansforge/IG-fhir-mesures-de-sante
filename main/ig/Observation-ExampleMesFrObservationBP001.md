# ExampleMesFrObservationBP001 - Guide d'implémentation FHIR - Mesures de santé v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleMesFrObservationBP001**

## Example Observation: ExampleMesFrObservationBP001
...
```json
{
  ...
  "id" : "ExampleMesFrObservationBP001",
  "meta" : {
    "profile" : [
