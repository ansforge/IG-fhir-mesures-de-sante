...
| [Glycémie](StructureDefinition-mesures-observation-glucose.md) | Profil de la ressource Observation pour définir une GlycémieCe profil permet de gérer 4 types d’indicateurs de glycémie:* le taux de glucose sanguin, mesuré en mg/dl
...
| [bundle-example](Bundle-bundle-example.md) |
