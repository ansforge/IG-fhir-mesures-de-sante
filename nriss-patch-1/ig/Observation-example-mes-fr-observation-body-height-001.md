# Exemple de mesure de taille corporelle - Guide d'implémentation FHIR - Mesures de santé v3.2.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-fr-observation-bodyheight"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
