# ExampleMesFrRespRate - Guide d'implémentation FHIR - Mesures de santé v3.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleMesFrRespRate**

## Example Observation: ExampleMesFrRespRate
