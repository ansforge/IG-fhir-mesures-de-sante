...
* original-value: 4.9 g/L (Détails : code UCUMg/L = 'gram per liter')
...
**value**: 5.6 mmol/L (Détails : code UCUMmmol/L = 'millimole per liter')
...
| :--- | :--- | :--- |
| - | **Low** | **High** |
| * | 2.8 mmol/L (Détails : code UCUMmmol/L = 'millimole per liter') | 21.1 mmol/L (Détails : code UCUMmmol/L = 'millimole per liter') |
