...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "urn:uuid:example-mes-fr-diagnostic-report-cholesterol-003",
      "resource" : {
    ...
    {
      "fullUrl" : "urn:uuid:example-mes-fr-observation-cholesterol-ldl-003",
      "resource" : {
        "resourceType" : "Observation",
        "id" : "example-mes-fr-observation-cholesterol-ldl-003",
        "meta" : {
          "profile" : [
    ...
    {
      "fullUrl" : "urn:uuid:example-mes-fr-observation-cholesterol-hdl-003",
      "resource" : {
        "resourceType" : "Observation",
        "id" : "example-mes-fr-observation-cholesterol-hdl-003",
        "meta" : {
          "profile" : [
    ...
    {
      "fullUrl" : "urn:uuid:example-mes-fr-observation-cholesterol-trigly-003",
      "resource" : {
        "resourceType" : "Observation",
    ...
    {
      "fullUrl" : "urn:uuid:example-mes-fr-observation-cholesterol-total-003",
      "resource" : {
        "resourceType" : "Observation",
        "id" : "example-mes-fr-observation-cholesterol-total-003",
        "meta" : {
          "profile" : [
    ...
    {
      "fullUrl" : "urn:uuid:example-mes-fr-observation-glycemia-003",
      "resource" : {
        "resourceType" : "Observation",
        "id" : "example-mes-fr-observation-glycemia-003",
        "meta" : {
          "profile" : [
