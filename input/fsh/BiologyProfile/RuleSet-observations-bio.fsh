...
* extension contains
    mesures-original-data named mes-original-data 0..1

* extension[mes-original-data] ^short = "Valeur d'origine de la donnée. Cette extension est présente uniquement si le résultat contenu dans Observation.value provient d'une conversion (par ex. g/L converti en mmol/L)"
