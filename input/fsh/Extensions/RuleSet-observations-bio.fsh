...
* extension contains
    mesures-original-value named MesOriginalValue 0..1

* extension[mesures-original-value] ^short = "Valeur d'origine de la donnée. Cette extension est présente uniquement si le résultat contenu dans Observation.value provient d'une conversion (par ex. g/L converti en mmol/L)"
