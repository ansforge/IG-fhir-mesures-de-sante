# ExampleMesFrObservationBodyTemperature001 - Guide d'implémentation FHIR - Mesures de santé v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleMesFrObservationBodyTemperature001**

## Example Observation: ExampleMesFrObservationBodyTemperature001
...
```json
{
  ...
  "id" : "ExampleMesFrObservationBodyTemperature001",
  "meta" : {
    "profile" : [
