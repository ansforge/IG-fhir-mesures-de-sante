# ExampleMesFrObservationBmi001 - Guide d'implémentation FHIR - Mesures de santé v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleMesFrObservationBmi001**

## Example Observation: ExampleMesFrObservationBmi001
...
```json
{
  ...
  "id" : "ExampleMesFrObservationBmi001",
  "meta" : {
    "profile" : [
