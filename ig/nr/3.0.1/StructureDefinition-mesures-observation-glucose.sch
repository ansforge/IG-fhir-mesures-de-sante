...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-diabetis-type']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-diabetis-type': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
