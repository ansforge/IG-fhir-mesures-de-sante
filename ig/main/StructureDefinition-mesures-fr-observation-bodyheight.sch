...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile FrObservationBodyHeight
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://interopsante.org/fhir/StructureDefinition/FrObservationHeightBodyPosition']) &lt;= 1">extension with URL = 'http://interopsante.org/fhir/StructureDefinition/FrObservationHeightBodyPosition': maximum cardinality of 'extension' is 1</sch:assert>
